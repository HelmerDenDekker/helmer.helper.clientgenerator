...
using Helmer.PetStore.Kiota.Api.Models;
using Microsoft.AspNetCore.Mvc;

namespace Helmer.PetStore.Kiota.Api.Controllers;
...
public class PetController : ControllerBase
{
    ...
    {
        // TODO: implement
        return Ok(new ApiResponse { Code = 200, Type = "unknown", Message = "File uploaded." });
    }
}
